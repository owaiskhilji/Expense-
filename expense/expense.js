var expenses = [] ;
var totalamount = 0; //total amount krne ki waja se bna ya h

var opt = document.getElementById('opt') //feild ko khali krne ki waja se var bna ya h
...
addbtn.addEventListener('click', function() {
    ...
    cetegoryselect.value = opt.value //is btn k clk pr feld khali hori h
    amountinput.value = '' //is btn k clk pr feld khali hori h
    dateinput.value = '' //is btn k clk pr feld khali hori h
